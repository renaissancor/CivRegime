# World Ethnicities Reference
## Organized by Affinity Bloc → People Cluster → Ethnic Group
...
## 7. SOUTHEAST ASIAN & OCEANIC BLOC

### 7.1 Austronesian Cluster
- Malay / Indonesian
- Javanese
- Filipino
- Tagalog
...
- Melanesian (Fijian, Vanuatu peoples)
- Micronesian (Chamorro, Palauan)

### 7.3 Aboriginal Cluster
- Aboriginal Australian
- Torres Strait Islander

---

## 8. AMERICAN INDIGENOUS BLOC
...
### 8.4 Amazonian & Other South American Cluster
- Guarani
- Mapuche
- Tupi
- Yanomami
...
## 11. DIASPORA & COSMOPOLITAN COMMUNITIES

### 11.1 Religious-Ethnic Groups
- Jewish
- Parsi (Zoroastrian)
- Ismaili
- Coptic

### 11.2 Trading & Merchant Communities
- Lebanese diaspora
- Armenian diaspora
- Greek diaspora
- Chinese diaspora
...
### 11.3 Hybrid & Multi-ethnic Groups
- Creole (Caribbean, Louisiana)
- Métis (Franco-Canadian indigenous)
- Mestizo (Spanish-Indigenous Latin America)
- Mulatto (African-European diaspora)
